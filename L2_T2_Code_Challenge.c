// Created by kuntal on 08-07-2021.
/*
...
Hint: To check if a number is a palindrome or not, you need to first reverse the number
...
Enter 'num'
Store the 'num' in a separate variable 'originalNum'
(so that it can be compared with the reversedNumber at the end of the program)
