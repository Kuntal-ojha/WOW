// This is my First Game Making Project.
// Created by KUNTAL OJHA RAJ on 7/31/2020.
// Here i use some new keyword. Don't worry i will describe every function and keyword when i use it.
#include <stdio.h>
// Use for random variable.
#include <stdlib.h>
#include <time.h>
int main()
{
        int a; // a is variable who store players number.
        int b,c,k,n,d;
        time_t t;
        srand((unsigned) time(&t));
        // char name1[25];char name2[25];char name3[25];char name4[25];char name5[25];char name6[25];
        // I use this for store a Name. This is use of string.
        // char name7[25];char name8[25];char name9[25];char name10[25];
        char name1[25];
        char name2[25];
        char name3[25];
        char name4[25];
        ...
        // This scanf function use store the player number (player)
        scanf("%d",&a);
        //
        if (a>=2&&a<=10)
        {
